...
O [CI remoto 34905435615](../reports/ci/34905435615/execucao.json) concluiu com sucesso no commit `9bee7b6`, incluindo testes, builds, DAG, stack e armazenamento da imagem validada. A ocorrência de paridade e sua correção permanecem registradas separadamente no diagnóstico por camada. Os relatórios do retreino local estão em `reports/airflow/` e identificam `20260914T221243-003d412d`; os relatórios de cada CI ficam em `reports/ci/<execucao>/`.
